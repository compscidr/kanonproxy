...
class IfReq(@JvmField var flags: Short = 0, nameString: String = ""): Structure() {
    ...
    override fun toString(): String {
        return "IfReq(name=${Native.toString(name, StandardCharsets.US_ASCII)}, flags=$flags, padding length=${padding.size})"
    }
}